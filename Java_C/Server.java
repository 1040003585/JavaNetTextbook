...
public class Server {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//DataInputStream dis=new DataInputStream(socket.getInputStream());//dis.readUTF();// 
			//DataOutputStream dos=new DataOutputStream(socket.getOutputStream());//dos.writeUTF(string);dos.flush();

			BufferedReader br=new BufferedReader(new InputStreamReader(socket.getInputStream()));//br.readLine();
