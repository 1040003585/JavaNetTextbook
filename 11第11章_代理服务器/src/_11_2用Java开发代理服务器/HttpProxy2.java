 ...
 * Date/Time: 2016-6-15/下午01:17:04
 * Description: http://chenyu-hz.iteye.com/blog/1493227
 */
public class HttpProxy2 extends Thread {
	...
	static public void stopProxy(){
		try {
			if(null!=HttpProxy2.socket)
			HttpProxy2.socket.close();
	...
	static public void main(String args[]) {
		...
		HttpProxy2.log = System.out;
		HttpProxy2.logging = false;
		HttpProxy2.startProxy(808, HttpProxy2.class);
	}
}
